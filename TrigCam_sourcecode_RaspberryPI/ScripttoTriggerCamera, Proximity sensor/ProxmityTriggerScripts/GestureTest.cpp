...
int main() {
	...
	while(1) {
cout<< "before executing isrflag"<<endl;
		if( isr_flag == 1 ) {
cout<< "before handgesture loop"<< endl;
			handleGesture();
			isr_flag = 0;
		}
	}
...
void handleGesture() {
cout << "in hand gesture loop"<<endl;
	if ( apds.isGestureAvailable() ) {
cout<<"ifgestavail"<<endl;
apds.readGesture();
cout<<"Gesture ava"<<endl;

/*		switch ( apds.readGesture() ) {
cout<<"Read gesture switch case"<<endl;
		case DIR_UP:
			cout << "UP" << endl;
			break;
		case DIR_DOWN:
